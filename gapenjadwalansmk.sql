...
-- Dumping structure for table gapenjadwalansmk.activity_log
...
-- Dumping data for table gapenjadwalansmk.activity_log: ~0 rows (approximately)

-- Dumping structure for table gapenjadwalansmk.guru
...
-- Dumping data for table gapenjadwalansmk.guru: ~10 rows (approximately)
...
-- Dumping structure for table gapenjadwalansmk.jadwal
...
-- Dumping data for table gapenjadwalansmk.jadwal: ~0 rows (approximately)

-- Dumping structure for table gapenjadwalansmk.jadwal_detail
...
-- Dumping data for table gapenjadwalansmk.jadwal_detail: ~0 rows (approximately)

-- Dumping structure for table gapenjadwalansmk.jam_pelajaran
...
-- Dumping data for table gapenjadwalansmk.jam_pelajaran: ~12 rows (approximately)
...
-- Dumping structure for table gapenjadwalansmk.kelas
...
-- Dumping data for table gapenjadwalansmk.kelas: ~18 rows (approximately)
...
-- Dumping structure for table gapenjadwalansmk.mata_pelajaran
...
-- Dumping data for table gapenjadwalansmk.mata_pelajaran: ~15 rows (approximately)
...
-- Dumping structure for table gapenjadwalansmk.penugasan_guru
...
-- Dumping data for table gapenjadwalansmk.penugasan_guru: ~30 rows (approximately)
...
-- Dumping structure for table gapenjadwalansmk.preferensi
...
-- Dumping data for table gapenjadwalansmk.preferensi: ~10 rows (approximately)
...
-- Dumping structure for table gapenjadwalansmk.ruangan
...
-- Dumping data for table gapenjadwalansmk.ruangan: ~20 rows (approximately)
...
-- Dumping structure for table gapenjadwalansmk.tahun_ajaran
...
-- Dumping data for table gapenjadwalansmk.tahun_ajaran: ~2 rows (approximately)
...
-- Dumping structure for table gapenjadwalansmk.users
...
-- Dumping data for table gapenjadwalansmk.users: ~10 rows (approximately)
